...
from app3.menus.util import clear_screen, simple_number, pause, print_panel
from app3.menus.package import show_package_details, get_package_details
...
def show_bookmark_menu(return_package_detail: bool = False):
    ...
    while True:
        ...
        nav.add_row("00", f"[{theme['text_sub']}]Cabut balik ke menu awal 🏠[/]")
        nav.add_row("000", f"[{theme['text_err']}]Hapus Bookmark cuy 🗑️ [/]")

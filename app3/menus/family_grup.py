...
from app3.menus.util import clear_screen, pause, print_panel, live_loading, simple_number
...
def show_family_grup_menu(return_package_detail: bool = False):
    while True:
        ...
        if semua_kode:
            nav_table.add_row("E", "Edit nama family code ✏️ ")
            nav_table.add_row("H", f"[{theme['text_err']}]Hapus family code 🗑️ [/]")
        nav_table.add_row("00", f"[{theme['text_sub']}]Cabut balik ke menu awal 🏠[/]")
